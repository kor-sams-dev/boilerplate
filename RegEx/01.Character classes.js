...
console.log("Character set:", characterSetResult); // [ 'a', 'b', 'c' ]
...
console.log("Negated set:", negatedSetResult); // [ 'd', 'e', 'f', 'g' ]
...
console.log("Range:", rangeResult); // [ 'a', 'b', 'c', 'd', 'e', 'f', 'g' ]
...
console.log("Dot:", dotResult); // [ 'a', 'b', 'c', 'd', 'e', 'f', 'g' ]
...
console.log("Match any:", matchAnyResult); // [ ' ', 'a', ' ', 'b', ' ', 'c' ]
...
console.log("Word:", wordResult); // [ 'a', 'b', 'c' ]
...
console.log("Not word:", notWordResult); // [ ' ', ' ' ]
...
console.log("Digit:", digitResult); // [ '1', '2', '3' ]
...
console.log("Not digit:", notDigitResult); // [ 'a', 'b', 'c' ]
...
console.log("Whitespace:", whitespaceResult); // [ ' ' ]
